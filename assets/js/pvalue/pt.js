...
function init() {
   ...
   document.getElementById("input").style.color = "#eaeaea";
   document.getElementById("input").innerHTML = "t = <code>"+t+"</code>,  df = <code>"+n+"</code>";
   document.getElementById("output").innerHTML = "Right-tail p-value is <code>"+p+"</code>";
   document.getElementById("Rcommand").innerHTML = "R command: <code>pt("+mt+", "+n+")</code> or <code>pt("+t+", "+n+", lower.tail=FALSE)</code>";
   drawCurve(t,n, 1);
}
...
function Pfromt_t(form) {
  ...
  document.getElementById("input").innerHTML = "t = <code>"+t+"</code>,  df = <code>"+n+"</code>";
  if (ptype==0) {
    document.getElementById("output").innerHTML = "Left-tail p-value is <code>"+pval+"</code>";
    document.getElementById("Rcommand").innerHTML = "R command: <code>pt("+t+", "+n+")</code>";
  } else if (ptype==1) { 
    document.getElementById("output").innerHTML = "Right-tail p-value is <code>"+pval+"</code>";
    document.getElementById("Rcommand").innerHTML = "R command: <code>pt("+mt+", "+n+")</code> or <code>pt("+t+", "+n+", lower.tail=FALSE)</code>";
  } else if (ptype==2) {
    document.getElementById("output").innerHTML = "Two-tails p-value is <code>"+pval+"</code>";
    document.getElementById("Rcommand").innerHTML = "R command: <code>2*pt("+mt+", "+n+")</code> or <code>2*pt("+abst+", "+n+", lower.tail=FALSE)</code>";
  } else {
    document.getElementById("output").innerHTML = "Middle area is <code>"+pval+"</code>";
    document.getElementById("Rcommand").innerHTML = "R command: <code>1-2*pt("+mt+", "+n+")</code>";
  }
...
function tfromP_t(form) {
  ...
  form.t.value = tval;
  document.getElementById("input").style.color = "#eaeaea";
  document.getElementById("output").innerHTML = "t-value is <code>"+tval+"</code>";
  if (ptype==0) {
    document.getElementById("input").innerHTML = "Left-tail p-value is <code>"+p+"</code>,  df = <code>"+n+"<code>";
    document.getElementById("Rcommand").innerHTML = "R command: <code>qt("+p+", "+n+")</code>";
  } else if (ptype==1) {
    document.getElementById("input").innerHTML = "Right-tail p-value is <code>"+p+"</code>,  df = <code>"+n+"<code>";
    document.getElementById("Rcommand").innerHTML = "R command: <code>-qt("+p+", "+n+")</code> or <code>qt("+p+", "+n+", lower.tail=FALSE)</code>";
  } else if (ptype==2) {
    document.getElementById("input").innerHTML = "Two-tails p-value is <code>"+p+"</code>,  df = <code>"+n+"</code>";
    document.getElementById("Rcommand").innerHTML = "R command: <code>-qt("+p+"/2, "+n+")</code> or <code>qt("+p+"/2, "+n+", lower.tail=FALSE)</code>";
  } else {
    document.getElementById("input").innerHTML = "Middle area is <code>"+p+"</code>,  df = <code>"+n+"</code>";
    document.getElementById("Rcommand").innerHTML = "R command: <code>-qt( (1-"+p+")/2, "+n+")</code>";
  }
