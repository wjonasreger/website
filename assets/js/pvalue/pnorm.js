...
function init() {
  ...
  document.getElementById("input").innerHTML = "Z-score: <code>"+z+"</code>";
  document.getElementById("output").innerHTML = "Right-tail p-value is <code>"+p+"</code>";
  document.getElementById("Rcommand").innerHTML = "R command: <code>pnorm("+mz+")</code> or <code>pnorm("+z+", lower.tail=FALSE)</code>";
  drawCurve(z, 1);
}
...
function changePtype(form, type) {
  ...
  if (outputStr.indexOf("p-value") != -1 || outputStr.indexOf("Middle area") != -1) {
    ...
    if (ptype==0) {
      ...
      document.getElementById("output").innerHTML = "Left-tail p-value is <code>"+p+"</code>";
      document.getElementById("Rcommand").innerHTML = "R command: <code>pnorm("+z+")</code>";
    } else if (ptype==1) {
      var p = 0.06681;
      form.p_value.value = p;
      document.getElementById("output").innerHTML = "Right-tail p-value is <code>"+p+"</code>";
      ...
      var p = 0.1336;
      form.p_value.value = p;
      document.getElementById("output").innerHTML = "Two-tails p-value is <code>"+p+"</code>";
      document.getElementById("Rcommand").innerHTML = "R command: <code>2*pnorm(-"+absz+")</code> or <code>2*pnorm("+absz+", lower.tail=FALSE)</code>";
    } else {
      var p = 0.8664;
      form.p_value.value = p;
      document.getElementById("output").innerHTML = "Two-tails p-value is <code>"+p+"</code>";
      document.getElementById("Rcommand").innerHTML = "R command: <code>1-2*pnorm(-"+absz+")</code>";
    }
    drawCurve(z, ptype);
  }
}
...
function PfromZ_normal(form) {
  ...
  if (ptype==0) {
    ...
    document.getElementById("output").innerHTML = "Middle area is <code>"+p+"</code>";
    document.getElementById("Rcommand").innerHTML = "R command: <code>1-2*pnorm(-"+absz+")</code>";  
  }
  drawCurve(z, ptype);
}
...
function ZfromP_normal(form) {
    ...
    document.getElementById("input").style.color = "#eaeaea";
    document.getElementById("output").innerHTML = "Z-score is <code>"+zval+"</code>";
    if (ptype==0) {
      document.getElementById("input").innerHTML = "Left-tail p-value: <code>"+p+"</code>";
      document.getElementById("Rcommand").innerHTML = "R command: <code>qnorm("+p+")</code>";
    } else if (ptype==1) {
      document.getElementById("input").innerHTML = "Right-tail p-value: <code>"+p+"</code>";
      document.getElementById("Rcommand").innerHTML = "R command: <code>-qnorm("+p+")</code> or <code>qnorm("+p+", lower.tail=FALSE)</code>";
    } else if (ptype==2) {
      document.getElementById("input").innerHTML = "Two-tails p-value: <code>"+p+"</code>";
      document.getElementById("Rcommand").innerHTML = "R command: <code>-qnorm("+p+"/2)</code> or <code>qnorm("+p+"/2, lower.tail=FALSE)</code>";
    } else {
      document.getElementById("input").innerHTML = "Middle area: <code>"+p+"</code>";
      document.getElementById("Rcommand").innerHTML = "R command: <code>-qnorm( (1-"+p+")/2)</code>";
    }
