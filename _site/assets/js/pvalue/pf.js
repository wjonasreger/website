...
function init() {
   ...
   document.getElementById("input").innerHTML = "F = <code>"+F+"</code>,  df1 = <code>"+df1+"</code>,  df2 = <code>"+df2+"</code>";
   document.getElementById("output").innerHTML = "Right-tail p-value is <code>"+p+"</code>";
   document.getElementById("Rcommand").innerHTML = "R command: <code>pf("+F+", "+df1+", "+df2+", lower.tail=FALSE)</code> or <code>1-pf("+F+", "+df1+", "+df2+")</code>";
...
function PfromF_F(form) {
  ...
  if (ptype==1) { 
    ...
    document.getElementById("Rcommand").innerHTML = "R command: <code>pf("+F+", "+df1+", "+df2+")</code>";
  }
...
function FfromP_F(form) {
  ...
  form.F.value = Fval;
  document.getElementById("input").style.color = "#eaeaea";
  document.getElementById("output").innerHTML = "F-value is <code>"+Fval+"</code>";
  if (ptype==1) {
    document.getElementById("input").innerHTML = "Right-tail p-value is <code>"+p+"</code>,  df1 = <code>"+df1+"</code>,  df2 = <code>"+df2+"</code>";
    document.getElementById("Rcommand").innerHTML = "R command: <code>qf("+p+", "+df1+", "+df2+", lower.tail=FALSE)</code> or <code>qf(1-"+p+", "+df1+", "+df2+")</code>";
  } else {
    document.getElementById("input").innerHTML = "Left-tail p-value is <code>"+p+"</code>,  df1 = <code>"+df1+"</code>,  df2 = <code>"+df2+"</code>";
    document.getElementById("Rcommand").innerHTML = "R command: <code>qf("+p+", "+df1+", "+df2+")</code>";
  }
