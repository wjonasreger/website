...
function init() {
   ...
   document.getElementById("input").innerHTML = "Chi-square = <code>"+chi2+"</code>,  df = <code>"+n+"</code>";
   document.getElementById("output").innerHTML = "Right-tail p-value is <code>"+p+"</code>";
   document.getElementById("Rcommand").innerHTML = "R command: <code>pchisq("+chi2+", "+n+", lower.tail=FALSE)</code> or <code>1-pchisq("+chi2+", "+n+")</code>";
   drawCurve(chi2,n, 1);
}
...
function PfromX2_chisq(form) {
  ...
  if (ptype==1) { 
    ...
    document.getElementById("Rcommand").innerHTML = "R command: <code>pchisq("+chi2+", "+n+")</code>";
  }
...
function X2fromP_chisq(form) {
  ...
  document.getElementById("input").style.color = "#eaeaea";
  document.getElementById("output").innerHTML = "Chi-square is <code>"+chi2val+"</code>";
  if (ptype==1) {
    document.getElementById("input").innerHTML = "Right-tail p-value is <code>"+p+"</code>,  df = <code>"+n+"</code>";
    document.getElementById("Rcommand").innerHTML = "R command: <code>qchisq("+p+", "+n+", lower.tail=FALSE)</code> or <code>qchisq(1-"+p+", "+n+")</code>";
  } else {
    document.getElementById("input").innerHTML = "Left-tail p-value is <code>"+p+"</code>,  df = <code>"+n+"</code>";
    document.getElementById("Rcommand").innerHTML = "R command: <code>qchisq("+p+", "+n+")</code>";
  }
